...
import (
	...
	"gitlab.com/golang-hse-2022/team1/tasks/client"
...
func makeClient(cmd *cobra.Command, args []string) (*client.TasksApp, error) {
...
func MakeRootCmd() (*cobra.Command, error) {
	...
	operationGroupHandlerCmd, err := makeOperationGroupHandlerCmd()
	if err != nil {
		return nil, err
	}
	rootCmd.AddCommand(operationGroupHandlerCmd)
...
func makeOperationGroupHandlerCmd() (*cobra.Command, error) {
	operationGroupHandlerCmd := &cobra.Command{
		Use:  "handler",
		Long: ``,
	}

	operationApproveCmd, err := makeOperationHandlerApproveCmd()
	if err != nil {
		return nil, err
	}
	operationGroupHandlerCmd.AddCommand(operationApproveCmd)

	operationCreateCmd, err := makeOperationHandlerCreateCmd()
	if err != nil {
		return nil, err
	}
	operationGroupHandlerCmd.AddCommand(operationCreateCmd)

	operationDeclineCmd, err := makeOperationHandlerDeclineCmd()
	if err != nil {
		return nil, err
	}
	operationGroupHandlerCmd.AddCommand(operationDeclineCmd)

	operationDeleteCmd, err := makeOperationHandlerDeleteCmd()
	if err != nil {
		return nil, err
	}
	operationGroupHandlerCmd.AddCommand(operationDeleteCmd)

	operationGetDescriptionCmd, err := makeOperationHandlerGetDescriptionCmd()
	if err != nil {
		return nil, err
	}
	operationGroupHandlerCmd.AddCommand(operationGetDescriptionCmd)

	operationGetTasksCmd, err := makeOperationHandlerGetTasksCmd()
	if err != nil {
		return nil, err
	}
	operationGroupHandlerCmd.AddCommand(operationGetTasksCmd)

	return operationGroupHandlerCmd, nil
}
